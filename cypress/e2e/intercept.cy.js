describe("Intercept", () => {
    ...
    it("Prueba de intercept simple", () => {
      ...
      //endpoints que se hacen posts por ejemplo en una compra de un producto
      // cy.intercept(
    ...
    it("Prueba de intercept forzando a que falle", () => {
    ...
    it.only("Prueba de intercept y cambiando el body", function () {
